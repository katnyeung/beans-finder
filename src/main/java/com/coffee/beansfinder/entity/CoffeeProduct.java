...
public class CoffeeProduct {
    ...
    /**
     * Consumer-friendly summary generated by LLM during crawl
     * Contains: flavor direction, best-for recommendations, tags, and one-liner description
     */
    @Type(JsonBinaryType.class)
    @Column(name = "consumer_summary", columnDefinition = "jsonb")
    private String consumerSummaryJson;
    ...
    /**
     * Condensed 40-80 word summary of the product description.
     * Generated by LLM during crawl to avoid copyright issues with verbatim descriptions.
     */
    @Column(columnDefinition = "TEXT")
    ...
    private LocalDateTime deletedAt; // Soft delete: null = active, timestamp = deleted
